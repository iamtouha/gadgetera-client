<template>
  <v-container>
    ...
    <p>Welcome to Gadget Era!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Gadget Era's Website, located at https://gadgeterabd.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Gadget Era if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing Gadget Era, you agreed to use
      cookies in agreement with the Gadget Era's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Gadget Era and/or its licensors own the
      intellectual property rights for all material on Gadget Era. All
      intellectual property rights are reserved. You may access this from Gadget
      Era for your own personal use subjected to restrictions set in these terms
      and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Gadget Era</li>
      <li>Sell, rent or sub-license material from Gadget Era</li>
      <li>Reproduce, duplicate or copy material from Gadget Era</li>
      <li>Redistribute content from Gadget Era</li>
    </ul>

    <p>
      This Agreement shall begin on the date hereof. Our Terms and Conditions
      were created with the help of the
      <a target="_blank" href="https://www.termsandconditionsgenerator.com">
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Gadget Era does
      not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of Gadget
      Era,its agents and/or affiliates. Comments reflect the views and opinions
      of the person who post their views and opinions. To the extent permitted
      by applicable laws, Gadget Era shall not be liable for the Comments or for
    ...
    <p>
      Gadget Era reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Gadget Era a non-exclusive license to use, reproduce,
    ...
    <p>
      ...
      hyperlink compensates the absence of Gadget Era; and (d) the link is in
    ...
    <p>
      ...
      e-mail to Gadget Era. Please include your name, your organization name,
    ...
    <p>
      No use of Gadget Era's logo or other artwork will be allowed for linking
